...
export const DEFAULT_SETTINGS: CompanySettings = {
  ...
  tagline: "Construction Equipment Hire",
  phone: "+27 78 456 6071",
  email: "Info@silumandube.co.za",
  website: "silumandube.co.za",
  address: "",
  vatNumber: "",
  regNumber: "2019/238479/07",
  bankAccounts: [
    {
      id: "bank-fnb",
      label: "First National Bank (FNB)",
      accountName: "Siluma N Dube Group (Pty) Ltd",
      bankName: "First National Bank (FNB)",
      accountNumber: "63096742565",
      branchCode: "201209",
    },
  ],
  defaultBankAccountId: "bank-fnb",
  defaultVatRate: 0.15,
  currencySymbol: "R",
  defaultTerms:
